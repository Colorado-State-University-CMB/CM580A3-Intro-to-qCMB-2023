...
plot(IL.6) # returns a scatter plot of our data
hist(IL.6) # returns a histogram of our data
boxplot(IL.6) # returns a boxplot of our data 
```
...
Here, go ahead and download the FASTQ file for this sample. This may take some time as it is a large file. This file will go to your downloads directory. I have also provided the FASTQ file on **canvas**. Either way, once you have this file, place it into the **HW directory** that you will be working out of for this assignment (This way you dont have to change any paths)!
